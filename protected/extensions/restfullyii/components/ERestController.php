 ...
 /**
  ...
  public function actionRestCreate($func=null)
  {
    ...
    else
    {
      ...
      $func = 'doCustomRestPost' . ucfirst($func);
  ...
  {      
    ...
    {
      $var = 'doCustomRestDelete' . ucfirst($var);
      if(method_exists($this, $var))
        $this->$var($id, $this->data());
      else if($this->isPk($id))
        $this->doRestDelete($id);
      else
        throw new CHttpException(500, 'Method does not exist.');
    }
  ...
  protected function renderJson()
  {
  	...
  	if($this->_dataType == 'encrypt'){
    	$this->layout = 'ext.restfullyii.views.layouts.html';
  ...
  public function doRestList()
  {
  	...
  	$this->_returnData['msg'] = 'Records Retrieved Successfully';
  	$this->_returnData['errorCode'] = '0000';
  	$this->_returnData['data'] = $this->getModel()->findAll();
    $this->renderJson();
  }
  ...
  public function doRestView($id)
  {
  	...
  	$this->_returnData['msg'] = 'Records Retrieved Successfully';
  	$this->_returnData['errorCode'] = '0000';
  	$this->_returnData['data'] = $this->getModel($id);
    $this->renderJson();
  }
  ...
  {    
    $model = $this->saveModel($this->loadModel($id), $data);
  	$this->_returnData['success'] = true;
  	$this->_returnData['msg'] = 'Record Updated';
  	$this->_returnData['errorCode'] = '0000';
  	$this->_returnData['data'] = array('id'=>$id);
    $this->renderJson();
  }
  ...
  public function doRestCreate($data)
  {
    ...
    $ids = $this->saveModel($model, $data);
  	...
  	$this->_returnData['success'] = true;
  	$this->_returnData['msg'] = 'Record(s) Created';
  	$this->_returnData['errorCode'] = '0000';
  	$this->_returnData['data'] = array('id'=>$ids);
    $this->renderJson();
  }
  ...
  public function doRestDelete($id)
  {
    ...
    if($model->delete()){
	  	$this->_returnData['success'] = true;
	  	$this->_returnData['msg'] = 'Record Deleted';
	  	$this->_returnData['errorCode'] = '0000';
	  	$this->_returnData['data'] = array('id'=>$id);
    }else{
  ...
  public function doCustomRestGetLimit($var)
  {
    ...
    $this->_returnData['msg'] = 'Records Retrieved Successfully';
    $this->_returnData['errorCode'] = '0000';
    $this->_returnData['data'] = $this->getModel()->findAll($criteria);
    $this->renderJson();
  }
  ...
  {
    $this->_returnData['success'] = true;
    $this->_returnData['msg'] = 'Record Count Retrieved Successfully';
    $this->_returnData['errorCode'] = '0000';
    $this->_returnData['data'] = array('count'=>count($this->getModel()->findAll()));
    $this->renderJson();
  }
  ...
  public function doCustomRestPostSearch($data)
  {
    ...
    $this->_returnData['msg'] = 'Records Retrieved Successfully';
    $this->_returnData['errorCode'] = '0000';
    $this->_returnData['data'] = $this->getModel()->findAllByAttributes($data);
    $this->renderJson();
  }
